...
class AppLocalizationsBn extends AppLocalizations {
  ...
  @override
  String get appTitle => 'নিকটবর্তী চেকার্স';

  @override
  String get homeTagline => 'কাছের কারো সাথে চেকার্স খেলুন\nইন্টারনেট ছাড়াই';
  ...
  @override
  String get homeLocalPlay => 'স্থানীয় খেলা (পাস এবং খেলুন)';

  @override
  String get homeBluetoothInfo => 'ব্লুটুথ ব্যবহার করে • অফলাইনে কাজ করে';

  @override
  String get localGameTitle => 'চেকার্স — স্থানীয় খেলা';
  ...
  String get drawOfferedContent =>
      'আপনার প্রতিপক্ষ ড্র প্রস্তাব করেছে। গ্রহণ করবেন?';
