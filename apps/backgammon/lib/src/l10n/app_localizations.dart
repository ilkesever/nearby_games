...
abstract class AppLocalizations {
  ...
  /// Button to roll dice / hint in move history
  ///
  /// In en, this message translates to:
  /// **'Roll Dice'**
  String get localGameRollDice;
  ...
  /// Status when it's white's turn
  ///
  /// In en, this message translates to:
  /// **'White\'s turn'**
  String get localGameWhiteTurn;

  /// Status when it's black's turn
  ///
  /// In en, this message translates to:
  /// **'Black\'s turn'**
  String get localGameBlackTurn;

  /// Label for the bar area
  ///
  /// In en, this message translates to:
  /// **'Bar'**
  String get localGameBar;

  /// Label for bearing off
  ///
  /// In en, this message translates to:
  /// **'Bear Off'**
  String get localGameBearOff;

  /// Message when no legal moves exist
  ///
  /// In en, this message translates to:
  /// **'No moves available — passing turn'**
  String get localGameNoMoves;
